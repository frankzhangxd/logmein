    ...
    $(document).ready(function() { 
        ...
        function test(){
            ...
            switch(localStorage.company){
                case 'DMS':
                    $page = "page-employee-signin.html";
                    if(localStorage.device == 'USER'){
                        $page = "page-project-signin.html";
                    }
                    localStorage.signType = 0;
                    break;
                case 'SUBTRADE':
                    $page = "page-subtrade-signin.html";
                    localStorage.signType = 1;
                    break;
                case 'VISITOR':
                    $page = "page-visitor-signin.html";
                    localStorage.signType = 2;
                    break;
                case 'SIGNOUT':
                    $page = "page-signout.html";
                    if(localStorage.device == 'USER'){
            ...
            xhr.onload = function (oEvent) {
                if (this.status == 200) {
                    localStorage.image = "https://dmscorp.ca/pm/images/profile/Sukhminder Saini.jpg";
                    $.ajax({
